...
public class WebClientConfig {
    ...
    @Bean
    public OAuth2AuthorizedClientProvider auth2AuthorizedClientProvider() {
    ...
    @Bean
    public WebClient webClientConfig(ServletOAuth2AuthorizedClientExchangeFilterFunction oauth2Client) {
